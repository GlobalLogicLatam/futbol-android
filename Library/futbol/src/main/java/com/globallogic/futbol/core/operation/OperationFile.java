...
public abstract class OperationFile extends Operation<File> {
     ...
     */
    public Boolean testResponse(StrategyFileMockResponse aMockResponse) {
     ...
     * @param OperationResponse<File> the http response
     * @see OperationHttp#workInBackground(Exception, int, String)
     * @see OperationHttp#afterWorkInBackground(Boolean)
     */
    ...
    public void sendBroadcastForNoInternet() {
        ...
        String actionWithId = OperationBroadcastReceiver.getActionForNoInternet(getClass());
    ...
    public void sendBroadcastForStart() {
        ...
        String actionWithId = OperationBroadcastReceiver.getActionForStart(getClass());
        intent.setAction(actionWithId);
        LocalBroadcastManager.getInstance(OperationApp.getInstance()).sendBroadcast(intent);
    ...
    public void sendBroadcastForOk() {
        ...
        String actionWithId = OperationBroadcastReceiver.getActionForOk(getClass());
        intent.setAction(actionWithId);
        LocalBroadcastManager.getInstance(OperationApp.getInstance()).sendBroadcast(intent);
    ...
    public void sendBroadcastForError() {
        ...
        String actionWithId = OperationBroadcastReceiver.getActionForError(getClass());
        intent.setAction(actionWithId);
        LocalBroadcastManager.getInstance(OperationApp.getInstance()).sendBroadcast(intent);
    ...
    public void sendBroadcastForFinish() {
        ...
        String actionWithId = OperationBroadcastReceiver.getActionForFinish(getClass());
        intent.setAction(actionWithId);
        LocalBroadcastManager.getInstance(OperationApp.getInstance()).sendBroadcast(intent);
     ...
     */
    private Boolean workInBackground(Exception anException, int aHttpCode, File aFile) {
    ...
    public boolean equals(Object o) {
        ...
        OperationFile operationFile = (OperationFile) o;

        if (!TextUtils.isEmpty(id) ? !id.equals(operationFile.id) : !TextUtils.isEmpty(operationFile.id))
            return false;
        if (timeInit != null ? !timeInit.equals(operationFile.timeInit) : operationFile.timeInit != null)
            return false;
