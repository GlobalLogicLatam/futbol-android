...
import com.globallogic.futbol.core.operation.OperationSqlite;
 ...
 */
public abstract class ExampleOperationSqlite extends OperationSqlite {

    public static final String ERROR_RESOURCE = "ERROR_RESOURCE";
    public static final int SECONDS = 3;
    public int errorResource = R.string.no_error;

    public ExampleOperationSqlite() {
        init();
    }

    public ExampleOperationSqlite(String id) {
        super(id);
        init();
    }
