...
import com.globallogic.futbol.core.operation.OperationFile;
 ...
 */
public abstract class ExampleOperationFile extends OperationFile {

    public static final String ERROR_RESOURCE = "ERROR_RESOURCE";
    public static final int SECONDS = 3;
    public int errorResource = R.string.no_error;

    public ExampleOperationFile() {
        init();
    }

    public ExampleOperationFile(String id) {
        super(id);
        init();
    }
